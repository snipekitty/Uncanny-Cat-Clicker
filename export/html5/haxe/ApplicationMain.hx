...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("UncannyCatClicker", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("UncannyCatClicker", null, 1080, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "98";
		app.meta["company"] = "woahman";
		app.meta["file"] = "UncannyCatClicker";
		app.meta["name"] = "Uncanny Cat Clicker";
		...
		#elseif air
		app.window.title = "Uncanny Cat Clicker";
		#else
