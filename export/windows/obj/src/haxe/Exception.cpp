...
HX_DEFINE_STACK_FRAME(_hx_pos_c9915fe03b50cdb0_5_new,"haxe.Exception","new",0xa32fba59,"haxe.Exception.new","D:\\Programming\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",5,0x79bad7ee)
HX_LOCAL_STACK_FRAME(_hx_pos_c9915fe03b50cdb0_56_toString,"haxe.Exception","toString",0x11a32013,"haxe.Exception.toString","D:\\Programming\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",56,0x79bad7ee)
HX_LOCAL_STACK_FRAME(_hx_pos_c9915fe03b50cdb0_76_get_message,"haxe.Exception","get_message",0x7b47a0d7,"haxe.Exception.get_message","D:\\Programming\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",76,0x79bad7ee)
HX_LOCAL_STACK_FRAME(_hx_pos_c9915fe03b50cdb0_19_caught,"haxe.Exception","caught",0xbc294f23,"haxe.Exception.caught","D:\\Programming\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",19,0x79bad7ee)
namespace haxe{

void Exception_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_c9915fe03b50cdb0_5_new)
...
::String Exception_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c9915fe03b50cdb0_56_toString)
...
::String Exception_obj::get_message(){
            	HX_STACKFRAME(&_hx_pos_c9915fe03b50cdb0_76_get_message)
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_message,return )
 ...
 ::haxe::Exception Exception_obj::caught( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_c9915fe03b50cdb0_19_caught)
