...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("UncannyCatClicker",21,fb,08,88),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("108",79,58,25,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("woahman",fb,c0,06,d5));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("UncannyCatClicker",21,fb,08,88));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Uncanny Cat Clicker",8d,9a,f0,a5));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Uncanny Cat Clicker",8d,9a,f0,a5))
