...
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1399_fromOpenFL,"flixel.text._FlxText.FlxTextAlign_Impl_","fromOpenFL",0xc584ea03,"flixel.text._FlxText.FlxTextAlign_Impl_.fromOpenFL","flixel/text/FlxText.hx",1399,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1415_toOpenFL,"flixel.text._FlxText.FlxTextAlign_Impl_","toOpenFL",0xa34e3094,"flixel.text._FlxText.FlxTextAlign_Impl_.toOpenFL","flixel/text/FlxText.hx",1415,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1385_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1385,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1392_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1392,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1394_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1394,0xdf165a6e)
...
::String FlxTextAlign_Impl__obj::fromOpenFL( ::Dynamic align){
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1399_fromOpenFL)
HXDLIN(1399)		if (::hx::IsNull( align )) {
HXLINE(1404)			return HX_("left",07,08,b0,47);
            		}
            		else {
HXDLIN(1399)			 ::Dynamic _hx_switch_0 = align;
            			if (  (_hx_switch_0==0) ){
HXLINE(1406)				return HX_("center",d5,25,db,05);
HXDLIN(1406)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==2) ){
HXLINE(1408)				return HX_("justify",50,df,b5,83);
HXDLIN(1408)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==3) ){
HXLINE(1405)				return HX_("left",07,08,b0,47);
HXDLIN(1405)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==4) ){
HXLINE(1407)				return HX_("right",dc,0b,64,e9);
HXDLIN(1407)				goto _hx_goto_0;
            			}
            			/* default */{
HXLINE(1409)				return HX_("left",07,08,b0,47);
            			}
            			_hx_goto_0:;
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxTextAlign_Impl__obj,fromOpenFL,return )
 ...
 ::Dynamic FlxTextAlign_Impl__obj::toOpenFL(::String align){
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1415_toOpenFL)
HXDLIN(1415)		::String _hx_switch_0 = align;
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE(1418)			return 0;
HXDLIN(1418)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("justify",50,df,b5,83)) ){
HXLINE(1420)			return 2;
HXDLIN(1420)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("left",07,08,b0,47)) ){
HXLINE(1417)			return 3;
HXDLIN(1417)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE(1419)			return 4;
HXDLIN(1419)			goto _hx_goto_2;
            		}
            		/* default */{
HXLINE(1421)			return 3;
            		}
            		_hx_goto_2:;
...
{
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1385_boot)
HXDLIN(1385)		LEFT = HX_("left",07,08,b0,47);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1392_boot)
HXDLIN(1392)		CENTER = HX_("center",d5,25,db,05);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1394_boot)
HXDLIN(1394)		RIGHT = HX_("right",dc,0b,64,e9);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1395_boot)
HXDLIN(1395)		JUSTIFY = HX_("justify",50,df,b5,83);
            	}
}
