...
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_478_addFrameCollection,"flixel.graphics.FlxGraphic","addFrameCollection",0x06dd03b1,"flixel.graphics.FlxGraphic.addFrameCollection","flixel/graphics/FlxGraphic.hx",478,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_495_getFramesCollections,"flixel.graphics.FlxGraphic","getFramesCollections",0xa4089c80,"flixel.graphics.FlxGraphic.getFramesCollections","flixel/graphics/FlxGraphic.hx",495,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_519_getEmptyFrame,"flixel.graphics.FlxGraphic","getEmptyFrame",0xc5b0f80f,"flixel.graphics.FlxGraphic.getEmptyFrame","flixel/graphics/FlxGraphic.hx",519,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_532_getBitmapFromSystem,"flixel.graphics.FlxGraphic","getBitmapFromSystem",0xb3be27b7,"flixel.graphics.FlxGraphic.getBitmapFromSystem","flixel/graphics/FlxGraphic.hx",532,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_547_get_isLoaded,"flixel.graphics.FlxGraphic","get_isLoaded",0xcad65c3f,"flixel.graphics.FlxGraphic.get_isLoaded","flixel/graphics/FlxGraphic.hx",547,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_552_get_isDestroyed,"flixel.graphics.FlxGraphic","get_isDestroyed",0x1abb03df,"flixel.graphics.FlxGraphic.get_isDestroyed","flixel/graphics/FlxGraphic.hx",552,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_557_get_canBeRefreshed,"flixel.graphics.FlxGraphic","get_canBeRefreshed",0xa65c7337,"flixel.graphics.FlxGraphic.get_canBeRefreshed","flixel/graphics/FlxGraphic.hx",557,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_562_get_canBeDumped,"flixel.graphics.FlxGraphic","get_canBeDumped",0x9b8a5e36,"flixel.graphics.FlxGraphic.get_canBeDumped","flixel/graphics/FlxGraphic.hx",562,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_567_incrementUseCount,"flixel.graphics.FlxGraphic","incrementUseCount",0xd3d6ae50,"flixel.graphics.FlxGraphic.incrementUseCount","flixel/graphics/FlxGraphic.hx",567,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_571_decrementUseCount,"flixel.graphics.FlxGraphic","decrementUseCount",0x44622234,"flixel.graphics.FlxGraphic.decrementUseCount","flixel/graphics/FlxGraphic.hx",571,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_579_checkUseCount,"flixel.graphics.FlxGraphic","checkUseCount",0xdc915169,"flixel.graphics.FlxGraphic.checkUseCount","flixel/graphics/FlxGraphic.hx",579,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_584_set_destroyOnNoUse,"flixel.graphics.FlxGraphic","set_destroyOnNoUse",0x5b353e31,"flixel.graphics.FlxGraphic.set_destroyOnNoUse","flixel/graphics/FlxGraphic.hx",584,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_593_get_imageFrame,"flixel.graphics.FlxGraphic","get_imageFrame",0xc1224382,"flixel.graphics.FlxGraphic.get_imageFrame","flixel/graphics/FlxGraphic.hx",593,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_602_get_atlasFrames,"flixel.graphics.FlxGraphic","get_atlasFrames",0x774c10a1,"flixel.graphics.FlxGraphic.get_atlasFrames","flixel/graphics/FlxGraphic.hx",602,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_606_set_bitmap,"flixel.graphics.FlxGraphic","set_bitmap",0x39ee9b13,"flixel.graphics.FlxGraphic.set_bitmap","flixel/graphics/FlxGraphic.hx",606,0xb3633517)
...
HXLINE( 452)		this->key = null();
HXLINE( 453)		this->assetsKey = null();
HXLINE( 454)		this->assetsClass = null();
HXLINE( 455)		this->imageFrame = ( ( ::flixel::graphics::frames::FlxImageFrame)(::flixel::util::FlxDestroyUtil_obj::destroy(this->get_imageFrame())) );
HXLINE( 457)		if (::hx::IsNull( this->frameCollections )) {
HXLINE( 458)			return;
            		}
HXLINE( 460)		::Array< ::Dynamic> collections;
HXLINE( 461)		{
HXLINE( 461)			int _g = 0;
HXDLIN( 461)			::Array< ::Dynamic> _g1 = this->frameCollectionTypes;
HXDLIN( 461)			while((_g < _g1->length)){
HXLINE( 461)				 ::flixel::graphics::frames::FlxFrameCollectionType collectionType = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrameCollectionType >();
HXDLIN( 461)				_g = (_g + 1);
HXLINE( 463)				collections = ( (::Array< ::Dynamic>)(this->frameCollections->get(collectionType)) );
HXLINE( 464)				::flixel::util::FlxDestroyUtil_obj::destroyArray(collections);
            			}
            		}
HXLINE( 467)		this->frameCollections = null();
HXLINE( 468)		this->frameCollectionTypes = null();
            	}
...
void FlxGraphic_obj::addFrameCollection( ::flixel::graphics::frames::FlxFramesCollection collection){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_478_addFrameCollection)
HXDLIN( 478)		if (::hx::IsNotNull( collection->type )) {
HXLINE( 480)			 ::flixel::graphics::frames::FlxFrameCollectionType type = collection->type;
HXDLIN( 480)			::cpp::VirtualArray collections;
HXDLIN( 480)			if (::hx::IsNull( this->shader )) {
HXLINE( 480)				::flixel::FlxG_obj::log->advanced(HX_("Invalid call to getFramesCollections on a destroyed graphic",1c,9c,0d,21),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/graphics/FlxGraphic.hx",17,35,63,b3),498,HX_("flixel.graphics.FlxGraphic",27,fc,ac,ae),HX_("getFramesCollections",d9,58,45,b4)));
HXDLIN( 480)				collections = ::cpp::VirtualArray_obj::__new(0);
            			}
            			else {
HXLINE( 480)				::cpp::VirtualArray collections1 = ( (::cpp::VirtualArray)(this->frameCollections->get(type)) );
HXDLIN( 480)				if (::hx::IsNull( collections1 )) {
HXLINE( 480)					collections1 = ::Array_obj< ::Dynamic>::__new();
HXDLIN( 480)					this->frameCollections->set(type,collections1);
            				}
HXDLIN( 480)				collections = collections1;
            			}
HXLINE( 481)			if (collections->contains(collection)) {
HXLINE( 482)				::flixel::FlxG_obj::log->advanced(HX_("Attempting to add already added collection",df,e0,7a,40),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/graphics/FlxGraphic.hx",17,35,63,b3),482,HX_("flixel.graphics.FlxGraphic",27,fc,ac,ae),HX_("addFrameCollection",ca,c7,4d,c6)));
            			}
            			else {
HXLINE( 484)				collections->push(collection);
            			}
            		}
            	}
...
::cpp::VirtualArray FlxGraphic_obj::getFramesCollections( ::flixel::graphics::frames::FlxFrameCollectionType type){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_495_getFramesCollections)
HXLINE( 496)		if (::hx::IsNull( this->shader )) {
HXLINE( 498)			::flixel::FlxG_obj::log->advanced(HX_("Invalid call to getFramesCollections on a destroyed graphic",1c,9c,0d,21),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/graphics/FlxGraphic.hx",17,35,63,b3),498,HX_("flixel.graphics.FlxGraphic",27,fc,ac,ae),HX_("getFramesCollections",d9,58,45,b4)));
HXLINE( 499)			return ::cpp::VirtualArray_obj::__new(0);
            		}
HXLINE( 502)		::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(this->frameCollections->get(type)) );
HXLINE( 503)		if (::hx::IsNull( collections )) {
HXLINE( 505)			collections = ::Array_obj< ::Dynamic>::__new();
HXLINE( 506)			this->frameCollections->set(type,collections);
            		}
HXLINE( 508)		return collections;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,getFramesCollections,return )
 ...
 ::flixel::graphics::frames::FlxFrame FlxGraphic_obj::getEmptyFrame( ::flixel::math::FlxBasePoint size){
            	HX_GC_STACKFRAME(&_hx_pos_3b8710f86d15c371_519_getEmptyFrame)
HXLINE( 520)		 ::flixel::graphics::frames::FlxFrame frame =  ::flixel::graphics::frames::FlxFrame_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),null(),null(),null(),null());
HXLINE( 521)		frame->type = 2;
HXLINE( 522)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
...
HXDLIN( 522)		frame->set_frame(rect);
HXLINE( 523)		{
HXLINE( 523)			 ::flixel::math::FlxBasePoint this1 = frame->sourceSize;
HXDLIN( 523)			{
HXLINE( 523)				Float y = size->y;
HXDLIN( 523)				this1->set_x(size->x);
HXDLIN( 523)				this1->set_y(y);
            			}
HXDLIN( 523)			{
HXLINE( 523)				 ::flixel::math::FlxBasePoint _this1 = size;
HXDLIN( 523)				if (_this1->_weak) {
HXLINE( 523)					_this1->put();
            				}
            			}
            		}
HXLINE( 524)		return frame;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,getEmptyFrame,return )
 ...
 ::openfl::display::BitmapData FlxGraphic_obj::getBitmapFromSystem(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_532_getBitmapFromSystem)
HXLINE( 533)		 ::openfl::display::BitmapData newBitmap = null();
HXLINE( 534)		if (::hx::IsNotNull( this->assetsClass )) {
HXLINE( 535)			newBitmap = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(this->assetsClass,::cpp::VirtualArray_obj::__new(0))) );
            		}
            		else {
HXLINE( 536)			if (::hx::IsNotNull( this->assetsKey )) {
HXLINE( 537)				 ::flixel::_hx_system::debug::log::LogStyle logStyle = null();
HXDLIN( 537)				newBitmap = ( ( ::openfl::display::BitmapData)(::flixel::FlxG_obj::assets->getAsset(this->assetsKey,HX_("image",5b,1f,69,bd),false,logStyle)) );
            			}
            		}
HXLINE( 539)		if (::hx::IsNotNull( newBitmap )) {
HXLINE( 540)			if (this->unique) {
HXLINE( 540)				return newBitmap->clone();
            			}
            			else {
HXLINE( 540)				return newBitmap;
            			}
            		}
...
bool FlxGraphic_obj::get_isLoaded(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_547_get_isLoaded)
HXDLIN( 547)		if (::hx::IsNotNull( this->bitmap )) {
HXDLIN( 547)			return !(this->bitmap->rect->isEmpty());
            		}
            		else {
...
bool FlxGraphic_obj::get_isDestroyed(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_552_get_isDestroyed)
HXDLIN( 552)		return ::hx::IsNull( this->shader );
            	}
...
bool FlxGraphic_obj::get_canBeRefreshed(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_557_get_canBeRefreshed)
HXDLIN( 557)		if (::hx::IsNull( this->assetsClass )) {
HXDLIN( 557)			return ::hx::IsNotNull( this->assetsKey );
            		}
            		else {
HXDLIN( 557)			return true;
            		}
...
bool FlxGraphic_obj::get_canBeDumped(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_562_get_canBeDumped)
HXDLIN( 562)		if (::hx::IsNull( this->assetsClass )) {
HXDLIN( 562)			return ::hx::IsNotNull( this->assetsKey );
            		}
            		else {
HXDLIN( 562)			return true;
            		}
...
void FlxGraphic_obj::incrementUseCount(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_567_incrementUseCount)
HXDLIN( 567)		this->useCount++;
            	}
...
void FlxGraphic_obj::decrementUseCount(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_571_decrementUseCount)
HXLINE( 572)		this->useCount--;
HXLINE( 574)		this->checkUseCount();
            	}
...
void FlxGraphic_obj::checkUseCount(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_579_checkUseCount)
HXDLIN( 579)		bool _hx_tmp;
HXDLIN( 579)		bool _hx_tmp1;
HXDLIN( 579)		if ((this->useCount <= 0)) {
HXDLIN( 579)			_hx_tmp1 = this->destroyOnNoUse;
            		}
            		else {
HXDLIN( 579)			_hx_tmp1 = false;
            		}
HXDLIN( 579)		if (_hx_tmp1) {
HXDLIN( 579)			_hx_tmp = !(this->persist);
            		}
            		else {
HXDLIN( 579)			_hx_tmp = false;
            		}
HXDLIN( 579)		if (_hx_tmp) {
HXLINE( 580)			::flixel::FlxG_obj::bitmap->remove(::hx::ObjectPtr<OBJ_>(this));
            		}
            	}
...
bool FlxGraphic_obj::set_destroyOnNoUse(bool value){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_584_set_destroyOnNoUse)
HXLINE( 585)		this->destroyOnNoUse = value;
HXLINE( 587)		this->checkUseCount();
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,set_destroyOnNoUse,return )
 ...
 ::flixel::graphics::frames::FlxImageFrame FlxGraphic_obj::get_imageFrame(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_593_get_imageFrame)
HXLINE( 594)		if (::hx::IsNull( this->imageFrame )) {
HXLINE( 595)			this->imageFrame = ::flixel::graphics::frames::FlxImageFrame_obj::fromRectangle(::hx::ObjectPtr<OBJ_>(this),null());
            		}
HXLINE( 597)		return this->imageFrame;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGraphic_obj,get_imageFrame,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxGraphic_obj::get_atlasFrames(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_602_get_atlasFrames)
HXDLIN( 602)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(::hx::ObjectPtr<OBJ_>(this),null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGraphic_obj,get_atlasFrames,return )
 ...
 ::openfl::display::BitmapData FlxGraphic_obj::set_bitmap( ::openfl::display::BitmapData value){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_606_set_bitmap)
HXLINE( 607)		if (::hx::IsNotNull( value )) {
HXLINE( 609)			this->bitmap = value;
HXLINE( 610)			this->width = this->bitmap->width;
HXLINE( 611)			this->height = this->bitmap->height;
HXLINE( 614)			int max = ::flixel::FlxG_obj::bitmap->get_maxTextureSize();
HXLINE( 615)			if ((max > 0)) {
HXLINE( 617)				bool _hx_tmp;
HXDLIN( 617)				if ((this->width <= max)) {
HXLINE( 617)					_hx_tmp = (this->height > max);
            				}
            				else {
HXLINE( 617)					_hx_tmp = true;
            				}
HXDLIN( 617)				if (_hx_tmp) {
HXLINE( 618)					::flixel::FlxG_obj::log->advanced(((((((((HX_("Graphic dimensions (",2d,00,e8,02) + this->width) + HX_("x",78,00,00,00)) + this->height) + HX_(") exceed the maximum allowed size (",85,74,6b,88)) + max) + HX_("x",78,00,00,00)) + max) + HX_("), which may cause rendering issues.",6e,bb,99,1f)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/graphics/FlxGraphic.hx",17,35,63,b3),618,HX_("flixel.graphics.FlxGraphic",27,fc,ac,ae),HX_("set_bitmap",2c,1e,11,e5)));
            				}
            			}
            		}
