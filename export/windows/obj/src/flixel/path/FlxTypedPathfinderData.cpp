...
HXLINE( 604)			::flixel::FlxG_obj::log->advanced(HX_("getPathIndices ended up somewhere other than the start",7c,aa,6e,b9),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flixel/path/FlxPathfinder.hx",58,41,45,74),604,HX_("flixel.path.FlxTypedPathfinderData",84,89,78,56),HX_("getPathIndicesTo",a7,2f,0e,93)));
            		}
